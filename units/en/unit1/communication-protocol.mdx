...
**Use cases** for this transport are local tools like file system access, running local scripts, accessing local databases.

</Tip>

The main **Advantages** of this transport are that it's simple, no network configuration required, and naturally sandboxed by the operating system.
