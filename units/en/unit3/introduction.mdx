...
- **Project Context**: Access team guidelines and code standards through MCP Resources  
- **CI/CD Monitoring**: Track GitHub Actions with Cloudflare Tunnel and standardized Prompts
- **Hugging Face Hub Integration**: Specialized workflows for LLM and dataset pull requests
...
1. **All Three MCP Primitives**: Master Tools, Resources, and Prompts through practical examples
...
This unit provides hands-on experience with all three MCP primitives:

- **Tools** (Module 1): Functions Claude can call to analyze files and suggest templates
- **Resources** (Module 2): Project context, team guidelines, and standards Claude can read
- **Prompts** (Module 3): Standardized workflows for consistent team processes
- **Integration** (Modules 4-5): All primitives working together for complex automation

## Module Structure

1. **Module 1: Build MCP Server** - Create a basic server with Tools for PR template suggestions
2. **Module 2: Smart File Analysis** - Add Resources to access project context and guidelines
3. **Module 3: GitHub Actions Integration** - Monitor CI/CD with Cloudflare Tunnel and Prompts
4. **Module 4: Hugging Face Hub Integration** - Specialized workflows for LLM and dataset PRs
5. **Module 5: Slack Notification** - Team communication integrating all MCP primitives
